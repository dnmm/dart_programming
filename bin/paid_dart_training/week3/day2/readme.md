# if statement :An if statement in programming is a control flow statement that allows you to execute a block of code only if a specified condition is true.
void main() {
 int a=10;
   int b=20;
  if (a>b){
